...
# "Add message" - appending new response to the previous one
# Instead of override, we want to refer old message for iteration
...
# Helper function, help me read the state base on different senario
